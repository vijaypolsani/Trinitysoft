  ...
  return (
    <Container className='flex items-center justify-center py-20'>
      <div className='min-h-[200px] flex flex-col items-center justify-center gap-y-5'>
        ...
        <div className='grid grid-cols-1 gap-4 place-content-evenly hover:place-content-center font-bold px-8 line-clamp-2 h-60 ...'>
          <div>Software implementation solutions and Staff augmentation services</div>
          <div><span/></div>
          <div><span/></div>
        </div>
