    ...
    <div className="relative">
      <Slider {...settings}>
        <div className="w-screen h-screen relative">
          <Image
            src={bannerone}
            alt="Software Project Implementation Partner and Technology Consulting Services Strategy and Cloud Design"
            className="w-screen h-screen relative"
            priority
          />
          <BannerText title="Sofware services on Google Cloud, Azure and AWS" />
        </div>
      </Slider>
    </div>
  );
